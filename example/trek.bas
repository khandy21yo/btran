...
101 DIM S%(10%,10%) : S%(I%,J%)=0% FOR I%=1% TO 8% FOR J%=1% TO 8%
102 DIM D%(10%,10%) : D%(I%,J%)=0% FOR I%=1% TO 8% FOR J%=1% TO 8%
300 PRINT "ORDERS:  ";
...
1000 PRINT "STARDATE -";D1%:PRINT:Q1%=3%:OPEN "morgul.bas" AS FILE 1%:
