...
2310 IFC1>=1AND C1<9THEN2350
2330 PRINT"   LT. SULU REPORTS, 'INCORRECT COURSE DATA, SIR!'":GOTO1990
2350 X$="8":IFD(1)<0THENX$="0.2"
2360 PRINT"WARP FACTOR (0-";X$;")";:INPUTW1:IFD(1)<0AND W1>.2THEN2470
2380 IFW1>0AND W1<=8THEN2490
2390 IFW1=0THEN1990
...
2790 D(I)=D(I)+D6:IFD(I)>-.1AND D(I)<0THEN D(I)=-.1:GOTO2880
...
3240 S8=INT(S1)*24+INT(S2)*3-26:IF MID$(Q$,S8,2)="  " THEN3360
...
4120 IFI>0AND I<9AND J>0AND J<9THENN(J-Q2+2)=G(I,J):Z(I,J)=G(I,J)
...
5150 FORI=1TO3:IFX3=K(I,1)AND Y3=K(I,2)THEN5190
5180 NEXTI:I=3
