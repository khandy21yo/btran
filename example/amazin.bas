10 REM ARKABLE PROGRAM BY JACK HAUBER, LOOMIS SCHOOL, WINDSOR, CT
20 REM ODELED FOR BASIC-PLUS BY DAVE AHL, DIGITAL
30 PRINT "THIS PROGRAM PRINTS OUT A MAZE OF DIMENSIONS UP TO 23 X 23."
40 PRINT "RUN THE PROGRAM AND THEN TRY TO NEGOTIATE THE MAZE!":PRINT
100 RANDOMIZE
110 DIM W(25,25),V(25,25)
112 FOR I=0 TO 25:FOR J=0 TO 25
113 W(I,J)=0:V(I,J)=0
114 NEXT J:NEXT I
120 INPUT "YOUR WIDTH";H: INPUT "AND LENGTH";V
122 PRINT
130 IF H<2 OR H>23 OR V<2 OR V>23 THEN 132 ELSE 150
